...
st.set_page_config(page_title="Hedef ve Verimlilik Paneli", layout="wide", page_icon="📊")

EXCEL_FILE = "veri.xlsx"

# Custom CSS - Hedef Paneli Koyu Tasarım + Fuşya Tablo Çerçeveleri
st.markdown("""
    <style>
...
if os.path.exists(EXCEL_FILE):
    ...
    st.error("⚠️ Proje klasöründe 'veri.xlsx' bulunamadı. Lütfen dosyanızı 'veri.xlsx' ismiyle ekleyin.")
